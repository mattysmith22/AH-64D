...
MPD_BOX_ARROW_C(ENG, MPD_POS_BUTTON_TB_1_X, MPD_POS_BUTTON_T_Y, 3)
...
MPD_BOX_ARROW_C(FLT, MPD_POS_BUTTON_TB_2_X, MPD_POS_BUTTON_T_Y, 3)
...
MPD_BOX_ARROW_C(PERF, MPD_POS_BUTTON_TB_4_X, MPD_POS_BUTTON_T_Y, 4)
...
MPD_BOX_ARROW_C(UTIL, MPD_POS_BUTTON_TB_6_X, MPD_POS_BUTTON_T_Y, 4)
...
MPD_BOX_C(CHECK, MPD_POS_BUTTON_TB_6_X, MPD_POS_BUTTON_B_Y, 5)
...
MPD_TEXT_SMALL_R(FTANKSTOT, 0.09, 0.80 + MPD_TEXT_SMALL_PAD + MPD_TEXT_HEIGHT, MPD_TEXT_STATIC("TOT"))
MPD_TEXT_R(FTANKSTOTQTY, 0.09 + (MPD_TEXT_SMALL_WIDTH * 4), 0.80 + MPD_TEXT_HEIGHT, MPD_TEXT_STATIC("8220"))
MPD_TEXT_SMALL_R(FTANKSTOTLB, 0.09 + (MPD_TEXT_SMALL_WIDTH * 5) + (MPD_TEXT_WIDTH * 4), 0.80 + MPD_TEXT_SMALL_PAD + MPD_TEXT_HEIGHT, MPD_TEXT_STATIC("LB"))
...
MPD_TEXT_SMALL_R(FENDR_TOT_TEXT, 0.69, 0.77 + MPD_TEXT_SMALL_HEIGHT + MPD_TEXT_HEIGHT + MPD_TEXT_SMALL_PAD, MPD_TEXT_STATIC("TOT"))
MPD_TEXT_L(FENDR_TOT_TIME, 0.69 + (MPD_TEXT_SMALL_WIDTH * 5) + (MPD_TEXT_WIDTH * 3.5), 0.77 + MPD_TEXT_SMALL_HEIGHT + MPD_TEXT_HEIGHT, MPD_TEXT_STATIC("8:30"))
...
// CROSSFEED
MPD_BOX_L(CFEED_AFT, MPD_POS_BUTTON_R_X, MPD_POS_BUTTON_LR_5_Y, 3)
...
MPD_BOX_L(CFEED_FWD, MPD_POS_BUTTON_R_X, MPD_POS_BUTTON_LR_3_Y, 3)
...
// Fuel boost
MPD_BOX_L(FBOOST, MPD_POS_BUTTON_R_X, MPD_POS_BUTTON_LR_2_Y, 6)
