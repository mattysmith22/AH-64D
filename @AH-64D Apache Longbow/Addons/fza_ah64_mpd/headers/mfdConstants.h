...
#define MFD_IND_TSD_SHOW_WIND 0
#define MFD_IND_TSD_SHOW_ENDR 1
#define MFD_IND_TSD_SHOW_WPT_DATA_CURRTE 2
#define MFD_IND_TSD_SHOW_ENEMY_UNITS 3
#define MFD_IND_TSD_SHOW_FRIENDLY_UNITS 4
#define MFD_IND_TSD_SHOW_RLWR 5
#define MFD_IND_TSD_SHOW_PLAN_TGTS 6
#define MFD_IND_TSD_SHOW_CTRLM 7
#define MFD_IND_TSD_SHOW_SHOT 8
#define MFD_IND_TSD_SHOW_HAZ 9
